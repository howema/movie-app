...
actor = Actor.create(first_name: "Angelina", last_name: "Jolie", known_for: "Tomb Raider", gender: "F", age: "46")

actor = Actor.create(first_name: "Val", last_name: "Kilmer", known_for: "The Saint", gender: "M", age: 61)
